...
(function LOADER() {
    ...
    let galleries = {
        ...
        vines: { name: "I am the Vine", gallerySize: 26, src: "./img/EXHIBITION-I-AM-THE-VINE/paintings/Vines-", carouselSrc: "./img/EXHIBITION-I-AM-THE-VINE/photos/I-am-the-vine-photo-", carouselSize: 23 },
        lilies: { name: "Lilies", gallerySize: 34, src: "./img/EXHIBITION-LILIES/paintings/Lilies-", carouselSrc: "./img/EXHIBITION-LILIES/photos/Lilies-photos-", carouselSize: 10 },
        waterLilies: { name: "Water Lilies", gallerySize: 36, src: "./img/EXHIBITION-WATER-LILIES/Water-lilies-" },
        landscapes: { name: "Landscapes", gallerySize: 37, src: "./img/LANDSCAPES/Landscapes-", dimensions: ["70 x 50", "50 x 70", "70 x 50", "70 x 50", "50 x 35", "50 x 35", "70 x 50", "29.7 x 21", "21 x 29.7", "40 x 30 x 4", "40 x 30 x 4", "50 x 70", "70 x 50", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "35 x 50", "35 x 50", "35 x 50", "70 x 50", "70 x 50", "35 x 50", "70 x 50", "70 x 50", "70 x 50", "70 x 50", "70 x 50", "70 x 50", "70 x 50", "70 x 50", "29.7 x 21", "29.7 x 21", "29.7 x 21", "21 x 29.7", "21 x 29.7"], base: ["hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "canvas", "canvas", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard"] },
        adriatic: { name: "Adriatic", gallerySize: 10, src: "./img/ADRIATIC/Adriatic-", dimensions: ["70 x 50", "70 x 50", "50 x 70", "70 x 50", "50 x 70", "29.7 x 21", "120 x 80 x 4", "50 x 70", "70 x 50", "50 x 70"], base: ["hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "canvas", "hardboard", "hardboard", "hardboard"] },
        stillLife: { name: "Still Life", gallerySize: 26, src: "./img/STILL-LIFE/Still-life-", dimensions:["50 x 70", "50 x 70", "70 x 50", "70 x 50", "50 x 70", "50 x 70", "50 x 70", "50 x 70", "50 x 70", "70 x 50", "50 x 70", "70 x 50", "70 x 50", "30 x 40 x 4", "50 x 70", "50 x 70", "50 x 70", "50 x 70", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7"], base:["hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "canvas", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard"] },
        blackAndWhite: { name: "Black and white in color", gallerySize: 39, src: "./img/BLACK-AND-WHITE/Black-And-White-", dimensions:["70 x 50", "21 x 29.7", "21 x 29.7", "50 x 70", "21 x 29.7", "21 x 29.7", "29.7 x 21", "29.7 x 21", "29.7 x 21", "29.7 x 21", "29.7 x 21", "21 x 29.7", "28 x 36 x 4", "28 x 36 x 4", "28 x 36 x 4", "50 x 70", "21 x 29.7", "30 x 30 x 4", "40 x 30 x 4", "30 x 40 x 4", "70 x 50", "29.7 x 21", "21 x 29.7", "50 x 70", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "50 x 70", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "21 x 29.7", "70 x 50", "50 x 70", "21 x 29.7", "50 x 70"], base:["hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "canvas", "canvas", "canvas", "hardboard", "hardboard", "canvas", "canvas", "canvas", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard", "hardboard"]},
        apstractions: { name: "Apstract art", gallerySize: 3, src: "./img/APSTRACTIONS/Apstractions-", titles: ["", "Life", "Vine"], dimensions: ["70 x 50", "140 x 50 x 4", "50 x 70"], base: ["hardboard", "canvas", "hardboard"] },
        poems: { name: "Poems", gallerySize: 24, src: "./img/POEMS/Poems-", titles: ["Ponekad", "Pjesma o pjesmi", "Ne želim", "Baka", "Kišobran", "Put", "Tingl-tangl-zvec", "Beskraj vremena", "Stara Cesta", "Pjesma oprosta","Ja", "Nekad sam pisao", "Patnja", "Svemirska paučina", "Pjesma svjedočanstva", "Naš čuvar", "Čamac na jedra", "Your dreams", "Pjesma samom sebi", ",Zarez,zarez,", "Fališ mi", "Božić dolazi", "Vau", "Život je prljavo kazalište"] }
        ...
        for (let i = numOfImgsToLoad; i >= 1; i--) {
            ...
            imageHTML += `<div class="col grid-item my-3 text-center">
                        ...
                        <div class="tag-background d-inline-block">
                            <h5 class="m-2 fs-5 text-center text-white font-Caveat  ${galleryName !== "poems" ? "d-none" : ""}">Text - Branko Pritišanac</h5>
                            <h5 class="m-2 fs-5 text-center text-white font-Caveat  ${galleryName !== "poems" ? "d-none" : ""}">Design - Tin Pritišanac</h5>
                        </div>
                    </div> `;
        ...
        if (modalState === "closed") { // to prevent bug when  clicking on image in open modal
            ...
            <div class="modal-dialog modal-fullscreen">
                    ...
                    <div class="modal-body d-flex text-center px-0">
                        <div class="container-fluid p-0 m-0">
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-12 col-lg-4 col-xxl-4 mt-4 d-flex justify-content-center ${galleryName == "poems" || galleryName == "vines" || galleryName == "lilies" || galleryName == "waterLilies" ? "d-none" : ""}">
                                    <div class="centering-div text-start font-Caveat fs-4">
                                    <p><span class="text-danger">Technique :</span> Oil on <span id="technique">${galleries[galleryName].base?.[imgElement.id - 1] || "canvas/hardboard"}</span></p>
                                    <p><span class="text-danger">Dimensions :</span> <span id="dimension">${galleries[galleryName].dimensions?.[imgElement.id - 1] || "AA x BB x CC"}</span> cm</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                function loadImage(direction) {
                    ...
                    modal.querySelector("#technique").textContent = galleries[galleryName].base?.[imgNumber - 1] || "canvas/hardboard";
